...
import {
  ...
  Clock, CheckCircle, Building2, Handshake, RefreshCw, Ticket as TicketIcon, Image as ImageIcon
} from 'lucide-react';
    ...
    <AdminLayout>
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
          ...
          <StatCard icon={<TicketIcon className="w-5 h-5" />} label="Tickets Sold" value={s.total_tickets_sold} />
          <StatCard icon={<CreditCard className="w-5 h-5" />} label="Ticket Revenue" value={s.ticket_revenue} sub={`${currency}${s.ticket_revenue.toLocaleString()}`} color="text-success" />
        </div>
