...
export const routes: RouteConfig[] = [
  ...
  { name: 'Tickets', path: '/tickets', element: <TicketsPage />, public: true },
  { name: 'Ticket Purchase', path: '/tickets/purchase/:id', element: <TicketPurchasePage />, public: true },
  ...
  { name: 'Admin Tickets', path: '/admin/tickets', element: <AdminTickets />, public: false },
  { name: 'Admin Hero Slides', path: '/admin/hero-slides', element: <AdminHeroSlides />, public: false },
